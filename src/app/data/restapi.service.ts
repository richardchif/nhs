...
getData():Observable<declaredData[]>{
 
  return this.http.get<declaredData[]>(this.apiURL+"/allData");
} 
/** POST: add a new owner to the database */
...
update(userData: declaredData): Observable<declaredData> {
  return this.http.post<declaredData>(this.apiURL+"/update",userData,{headers:new HttpHeaders({
    'Content-Type':'application/json'
  })
})
    .pipe(
...
updateP(userData: declaredData): Observable<declaredData> {
  return this.http.post<declaredData>(this.apiURL+"/updateP",userData,{headers:new HttpHeaders({
    'Content-Type':'application/json'
  })
})
    .pipe(
...
getPersonalData(EmployeeNumber:string):Observable<declaredData[]>{
  console.log(EmployeeNumber);
   return this.http.get<declaredData[]>(this.apiURL+"/allPD"+'/'+EmployeeNumber);
 }
/** POST: add a new owner to the database */
notify(EmployeeNumber:string):Observable<declaredData[]>{
  console.log(EmployeeNumber);
   return this.http.get<declaredData[]>(this.apiURL+"/note"+'/'+EmployeeNumber);
 }
